...
public class BlenderRenderer extends KineticBlockEntityRenderer<BlenderBlockEntity> {
	...
	@Override
	protected void renderSafe(BlenderBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		SuperByteBuffer superBuffer = CachedBufferer.partial(AllPartialModels.MILLSTONE_COG, blockState);
